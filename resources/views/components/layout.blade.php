          ...
          <div class="header">
            ...
            <div class="header-left">
                <a href="index.php" class="logo">
                    <img src="{{ asset('logo/logo-escola.png') }}" alt="Logo">
                </a>
                <a href="index.php" class="logo logo-small">
                    <img src="{{ asset('logo/logo-escola.png') }}" alt="Logo" width="30" height="30">
                </a>
            </div>
            <!-- /Logo -->
                    ...
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="{{ asset('logo/user.png') }}" alt="User Image" class="avatar-img rounded-circle">
                            </div>
                            <div class="user-text">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
                            ...
                            <li class="submenu">
								<a href="#"><i class="feather-grid"></i> <span>Exibir</span> <span class="menu-arrow"></span></a>
								<ul>
								    <li><a href="/exibir">Exibir</a></li> 	 
								</ul>
							</li> 
